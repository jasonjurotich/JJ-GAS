...
- all together: alias mo='mosh --ssh="ssh -i ~/.ssh/id_rsa" jasonjurotich@34.66.251.71' && alias df='git add -A && git commit -m "updated" && git push' && alias dg='git pull origin master'
