...
var sh = s.getSheetByName('EMAILSIHI');
...
//var pdf2 = DriveApp.getFileById('ID').getAs('application/pdf').getBytes();
//var attach2 = {fileName: 'TEXT',content:pdf2, mimeType:'application/pdf'};
// To add multiple attachmentes, just put [attach1,attach2]  
